> # Engineering notes
>
> This is the working record kept while the project was built, phase by phase:
> the design decisions and their reasoning, the bugs found and how, and the
> verification evidence for each phase.
>
> It is kept because most of the defensible material lives here — why a choice
> was made rather than only what was chosen. **For the project overview, setup
> and demo, see the [README](../README.md).**
